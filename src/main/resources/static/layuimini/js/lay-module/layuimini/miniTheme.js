        ...
        listen: function (options) {
            $('body').on('click', '[data-bgcolor]', function () {
                ...
                var html = '<div class="layuimini-color">\n' +
                    ...
                    '<a class="more-menu-item" href="http://itdfq.com" target="_blank"><i class="layui-icon layui-icon-read" style="font-size: 19px;"></i> 我的博客</a>\n' +
                    '<a class="more-menu-item" href="https://github.com/909256107" target="_blank"><i class="layui-icon layui-icon-tabs" style="font-size: 16px;"></i> 开源地址</a>\n' +
                    '</div>' +
                    '</div>';
                layer.open({
                    type: 1,
